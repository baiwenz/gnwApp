...
public class LocatAllAreaBRVAdapter extends BaseMultiItemQuickAdapter<MultiItemEntity, BaseViewHolder> {
     ...
     */
    public LocatAllAreaBRVAdapter(List<MultiItemEntity> data) {
        super(data);
