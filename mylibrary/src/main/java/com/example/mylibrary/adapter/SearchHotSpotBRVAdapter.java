...
public class SearchHotSpotBRVAdapter extends BaseQuickAdapter<AreaBean, BaseViewHolder> {
    public SearchHotSpotBRVAdapter(int layoutResId, @Nullable List<AreaBean> data) {
