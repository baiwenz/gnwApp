...
public class PendPaymentFragment extends Fragment {

    private RecyclerView mRvOrders;

    public static PendPaymentFragment newInstance() {
        PendPaymentFragment fragment = new PendPaymentFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        PerCenterForOrdersAdapter adapter = new PerCenterForOrdersAdapter(R.layout.item_for_pend_payment);
